<x-layout>
  ...
  <div class="py-5 px-5  mx-auto max-w-screen-xl lg:px-6">
  ...
  <div class="py-8 my-2 px-2 mx-auto max-w-screen-xl lg:py-13 lg:px-2">
      <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
          @forelse ($posts as $post)        
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 transition duration-300 transform hover:scale-105">
              <div class="flex justify-between items-center mb-5 text-gray-500">
                  <a href="/posts?category={{ $post->category->slug }}">
                      <span class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-sm inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:underline">
                          <img class="mr-1 w-3 h-3" src="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/bookmark-fill.svg" alt="Category Icon">
                          {{ $post->category->name }}
                      </span>
                  </a>
          ...
          <div class="text-center">
              <p class="text-2xl md:text-3xl font-bold tracking-wider text-gray-500 mt-4">Article Not Found</p>
